            ...
            <Element name="hero">
                <div className="container">
                    <div className=" relative z-2 mb-[90px]">
                        <h1 className=" mb-4 h1 text-p4 uppercase max-w-[872px] max-lg:max-w-388 max-lg:mb-7 max-lg:h2 max-md:mb-4 max-md:text-5xl max-md:leading-12">
                            Дизайнерские решения
                        </h1>
                        <p className="text-[89px] font-medium mb-8 ">для вашего бизнеса</p>
                        <LinkScroll to="contact" className=" mb-[250px]" offset={-100} spy smooth>
                            <Button>обсудить проект</Button>
                        </LinkScroll>
                    </div>

                    <div className=" absolute top-[33%] z-1 left-[10%] w-[590px] pointer-events-none">
